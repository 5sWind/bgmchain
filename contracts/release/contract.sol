...
// ReleaseOracle is an Bgmchain contract to store the current and previous
// versions of the go-bgmchain implementation. Its goal is to allow Gbgm to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Gbgm releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Gbgm release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an Bgmchain user, either
