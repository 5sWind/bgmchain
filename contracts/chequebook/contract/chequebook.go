...
// DeployChequebook deploys a new Bgmchain contract, binding an instance of Chequebook to it.
...
// Chequebook is an auto generated Go binding around an Bgmchain contract.
type Chequebook struct {
	ChequebookCaller     // Read-only binding to the contract
	ChequebookTransactor // Write-only binding to the contract
}

// ChequebookCaller is an auto generated read-only Go binding around an Bgmchain contract.
type ChequebookCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookTransactor is an auto generated write-only Go binding around an Bgmchain contract.
type ChequebookTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookSession is an auto generated Go binding around an Bgmchain contract,
...
// ChequebookCallerSession is an auto generated read-only Go binding around an Bgmchain contract,
...
// ChequebookTransactorSession is an auto generated write-only Go binding around an Bgmchain contract,
...
// ChequebookRaw is an auto generated low-level Go binding around an Bgmchain contract.
type ChequebookRaw struct {
	Contract *Chequebook // Generic contract binding to access the raw methods on
}

// ChequebookCallerRaw is an auto generated low-level read-only Go binding around an Bgmchain contract.
type ChequebookCallerRaw struct {
	Contract *ChequebookCaller // Generic read-only contract binding to access the raw methods on
}

// ChequebookTransactorRaw is an auto generated low-level write-only Go binding around an Bgmchain contract.
...
// MortalCaller is an auto generated read-only Go binding around an Bgmchain contract.
...
// MortalCallerSession is an auto generated read-only Go binding around an Bgmchain contract,
// with pre-set call options.
...
// MortalCallerRaw is an auto generated low-level read-only Go binding around an Bgmchain contract.
...
// OwnedCaller is an auto generated read-only Go binding around an Bgmchain contract.
...
// OwnedCallerSession is an auto generated read-only Go binding around an Bgmchain contract,
// with pre-set call options.
...
// OwnedCallerRaw is an auto generated low-level read-only Go binding around an Bgmchain contract.
