...
// Package chequebook package wraps the 'chequebook' Bgmchain smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in bgmchain; (auto)cashing cheques in bgmchain
// as well as (auto)depositing bgmchain to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/5sWind/bgmchain/contracts/chequebook/contract"
	"github.com/5sWind/bgmchain/core/types"
	"github.com/5sWind/bgmchain/crypto"
	"github.com/5sWind/bgmchain/log"
	"github.com/5sWind/bgmchain/swarm/services/swap/swap"
)
...
// * depositing bgmchain to the chequebook
...
// Cash cashes the cheque by sending an Bgmchain transaction.
