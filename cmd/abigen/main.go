...
import (
	...
	"github.com/5sWind/bgmchain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Bgmchain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Bgmchain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Bgmchain contract Solidity source to build and bind")
