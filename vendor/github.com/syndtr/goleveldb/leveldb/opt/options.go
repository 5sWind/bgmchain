...
type Options struct {
	...
	// ErrorIfExist defines whbgmchain an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whbgmchain an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whbgmchain block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whbgmchain to sync underlying writes from the OS buffer cache
