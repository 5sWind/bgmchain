...
// Condition have flag EastAsianWidth whbgmchain the current locale is CJK or not.
...
// IsAmbiguousWidth returns whbgmchain is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns whbgmchain is neutral width or not.
