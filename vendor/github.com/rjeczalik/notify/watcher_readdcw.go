...
// in order to distinguish whbgmchain current folder should be re-registered in
...
// watched is made in order to check whbgmchain an action comes from a directory or
...
// gensys decides whbgmchain the Windows action, system-independent event or both
