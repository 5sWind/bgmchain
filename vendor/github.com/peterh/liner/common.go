...
// SetCtrlCAborts sets whbgmchain Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whbgmchain line is auto-wrapped. The default is false (single line).
...
// whbgmchain to retry the call to, or return the error returned by, readNext.
