...
// shouldTraverse reports whbgmchain the symlink fi should, found in dir,
...
//
// The rename value tells goimports whbgmchain to use the package name as
...
// pkgIsCandidate reports whbgmchain pkg is a candidate for satisfying the
...
// canUse reports whbgmchain the package in dir is usable from filename,
...
// fileInDir reports whbgmchain the provided file path looks like
