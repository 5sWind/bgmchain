...
// private reports whbgmchain the Tag consists solely of a private use tag.
...
// whbgmchain there was any change.
...
// The confidence level indicates whbgmchain a value was explicitly specified,
// whbgmchain it is typically the only possible value, or whbgmchain there is
// an ambiguity.
type Confidence int
...
// wasn't found. The hasExt return value reports whbgmchain an -u extension was present.
...
func (t Tag) findTypeForKey(key string) (start, end int, hasExt bool) {
	...
	for {
		...
		if p3 := p + 3; s[p3] == '-' {
			// Found a key.
			// Check whbgmchain we just processed the key that was requested.
			if curKey == key {
				return start, p, true
			}
...
// IsCountry returns whbgmchain this region is a country or autonomous area. This
...
// IsGroup returns whbgmchain this region defines a collection of regions. This
// includes non-standard definitions from CLDR.
...
// Contains returns whbgmchain Region c is contained by Region r. It returns true
// if c == r.
