...
// IsEmpty reports whbgmchain the Set is empty.
func (s *set) IsEmpty() bool {
	return s.Size() == 0
}

// IsEqual test whbgmchain s and t are the same in size and have the same items.
...
// IsSubset tests whbgmchain t is a subset of s.
...
// IsSuperset tests whbgmchain t is a superset of s.
