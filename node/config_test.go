...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gbgm.ipc", false, filepath.Join(os.TempDir(), "gbgm.ipc")},
		{"data", "gbgm.ipc", false, "data/gbgm.ipc"},
		{"data", "./gbgm.ipc", false, "./gbgm.ipc"},
		{"data", "/gbgm.ipc", false, "/gbgm.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gbgm.ipc", true, `\\.\pipe\gbgm.ipc`},
		{"data", "gbgm.ipc", true, `\\.\pipe\gbgm.ipc`},
		{"data", `\\.\pipe\gbgm.ipc`, true, `\\.\pipe\gbgm.ipc`},
	}
