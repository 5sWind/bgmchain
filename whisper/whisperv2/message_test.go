...
// Tests whbgmchain a message can be wrapped without any identity or encryption.
...
// Tests whbgmchain a message can be signed, and wrapped in plain-text.
...
// Tests whbgmchain a message can be encrypted and decrypted using an anonymous
...
// Tests whbgmchain a message can be properly signed and encrypted.
