...
public class AndroidTest extends InstrumentationTestCase {
	...
	// signatures too. Regression test for go-bgmchain issue #14599.
...
func TestAndroid(t *testing.T) {
	// Skip tests on Windows altogbgmchain
	...
	// Generate the mobile bindings for Gbgm and add the tester class
