...
//
// bgm_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// bgm_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.BgmSubscribe(ctx, subch, "newBlocks")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "bgm_getBlockByNumber", "latest"); err != nil {
