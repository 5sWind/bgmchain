...
func makeTestState() (Database, *bgmdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := bgmdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db bgmdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db bgmdb.Database, root common.Hash) error {
...
func checkStateConsistency(db bgmdb.Database, root common.Hash) error {
