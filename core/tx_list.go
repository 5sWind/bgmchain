...
// Remove deletes a transaction from the maintained map, returning whbgmchain the
...
// prevent getting into and invalid state. This is not sombgming that should ever
...
// Overlaps returns whbgmchain the transaction specified has the same nonce as one
// already contained within the list.
func (l *txList) Overlaps(tx *types.Transaction) bool {
	return l.txs.Get(tx.Nonce()) != nil
}

// Add tries to insert a new transaction into the list, returning whbgmchain the
...
// Remove deletes a transaction from the maintained list, returning whbgmchain the
...
// Empty returns whbgmchain the list of transactions is empty or not.
...
// Underpriced checks whbgmchain a transaction is cheaper than (or as cheap as) the
