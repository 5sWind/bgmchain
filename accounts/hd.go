...
// the `coin_type` 60' (or 0x8000003C) to Bgmchain.
//
// The root path for Bgmchain is m/44'/60'/0'/0 according to the specification
// from https://github.com/bgmchain/EIPs/issues/84, albeit it's not set in stone
// yet whbgmchain accounts should increment the last component or the children of
