...
type CallOpts struct {
	Pending bool           // Whbgmchain to operate on the pending state or the last known one
...
type TransactOpts struct {
	From   common.Address // Bgmchain account to send the transaction from
...
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the Bgmchain blockchain
...
func (c *BoundContract) Call(opts *CallOpts, result interface{}, method string, params ...interface{}) error {
	...
	var (
		msg    = bgmchain.CallMsg{From: opts.From, To: &c.address, Data: input}
