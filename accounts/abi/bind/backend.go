...
type ContractCaller interface {
	...
	// ContractCall executes an Bgmchain contract call with the specified data as the
	// input.
...
type PendingContractCaller interface {
	...
	// PendingCallContract executes an Bgmchain contract call against the pending state.
