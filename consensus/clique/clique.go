...
var (
	...
	// errInvalidVote is returned if a nonce value is sombgming else that the two
...
type Clique struct {
	...
	signer common.Address // Bgmchain address of the signing key
...
func New(config *params.CliqueConfig, db bgmdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Bgmchain address recovered
