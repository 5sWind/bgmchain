...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db bgmdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db bgmdb.Database) error {
